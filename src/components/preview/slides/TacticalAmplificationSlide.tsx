...
export function TacticalAmplificationSlide({ property, deck, onFieldChange }: Props) {
  ...
  return (
    <div className="h-full w-full flex flex-col" style={{ backgroundColor: MINT }}>
      <div className="px-[5%] pt-[4%] pb-3">
        <SlideRichText
          fieldKey="tactical.amplification.headline"
          defaultValue="Marketing Amplification"
          defaultSize={20}
          customFields={cf}
